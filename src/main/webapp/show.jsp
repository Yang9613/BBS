...
<body class="sidebar_hidden">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown"> 
											...
											<c:if test="${sessionScope.user!=null}">
												<img src="user?action=read&id=${sessionScope.user.id}" alt="请登录" class="user_avatar" />
												${user.username}
											</c:if>
											<c:if test="${sessionScope.user==null}">
								...
								<ul class="dropdown-menu">
									...
									<li><a data-toggle="modal" id="my1" data-backdrop="static"
										...
										<c:if test="${sessionScope.user!=null}">
											<li>
												<a href="#post" title="灌水" data-toggle="modal"
	...
	<script type="text/javascript">
		$(function() {
			var username = $.cookie('http://www.papok.org/username'); // 获得cookie
			var password = $.cookie('http://www.papok.org/password');
